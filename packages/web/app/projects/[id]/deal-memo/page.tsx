...
export default function DealMemoPage() {
  ...
  function generate() {
    try {
      setError(null);
      applyProjectOp(params.id, (s) => actDraftDealMemo(s));
    } catch (e) {
  ...
  function approve() {
    try {
      setError(null);
      applyProjectOp(params.id, (s) => actApproveDealMemo(s));
    } catch (e) {
      setError(e instanceof Error ? e.message : String(e));
    }
  }
        ...
        <Card>
          ...
          {!dealMemo.approved && (
            <div className="p-4 border-t flex gap-2">
              <Button variant="success" onClick={approve} data-testid="approve-deal-memo-btn">
